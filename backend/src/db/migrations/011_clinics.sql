-- =============================================================================
-- 011: Create clinics table + FK from users.clinic_id
-- Enables the multi-tenant model: each clinic isolates its data.
-- =============================================================================
...
-- Authenticated users can read only their own clinic (via users.clinic_id)
...
-- Drop the older policy that references a non-existent table state
