-- =============================================================================
-- 014: Strengthen RLS — WITH CHECK on integrations + credentials
-- Adds INSERT/UPDATE policies so authenticated users can only write rows
-- scoped to their own clinic or user_id.
-- =============================================================================
