  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card><CardHeader className="pb-2"><CardTitle className="text-sm font-medium">Tasa de cancelación</CardTitle></CardHeader><CardContent><div className="text-2xl font-bold">{state.summary ? `${state.summary.cancellationRate}%` : '0%'}</div><p className="text-xs text-muted mt-1">Porcentaje de citas canceladas</p></CardContent></Card>
