...
export function AgentStatusCard() {
  ...
  const renderStatus = () => {
    if (loading) {
      return <div className="h-10 animate-pulse bg-card rounded mt-2" />
    }
      ...
      return (
        <div className="space-y-3">
          ...
          <p className="text-xs text-muted">
            Insights de IA y generación de contenido activos.
          </p>
        </div>
      )
    }
    ...
    return (
      <div className="space-y-3">
        ...
        <p className="text-xs text-muted">
          Conecta OpenAI o Gemini para habilitar las funciones de IA.
        </p>
      </div>
    )
  }
