-- =============================================================================
-- Add lead names to get_trazabilidad_funnel while preserving real revenue attribution.
--
...
CREATE FUNCTION public.get_trazabilidad_funnel(
...
COMMENT ON FUNCTION public.get_trazabilidad_funnel(UUID, DATE, DATE, DATE, DATE, DATE, DATE) IS
  'Returns acquisition lead -> first Doctoralia appointment -> posterior appointment funnel scoped by user, including lead_name and real Doctoralia revenue attributed once per settlement via patient link, explicit Doctoralia patient match, or normalized phone fallback.';
