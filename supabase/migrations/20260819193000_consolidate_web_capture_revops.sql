...
-- Runtime secrets are intentionally restricted to the small set required by
-- server-only RevOps workers. No browser/authenticated role can read or write them.
