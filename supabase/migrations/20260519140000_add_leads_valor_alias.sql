...
COMMENT ON COLUMN public.leads.valor IS 'Valor monetario del lead para priorización y CAPI (en EUR)';

-- Sincronizar valor inicial con revenue si ya existen datos
UPDATE public.leads SET valor = revenue WHERE valor = 0 AND revenue > 0;