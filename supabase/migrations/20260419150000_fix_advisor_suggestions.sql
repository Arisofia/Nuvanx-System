...
CREATE INDEX IF NOT EXISTS idx_financial_settlements_patient_id 
...
BEGIN
  IF EXISTS (
    ...
    EXECUTE 'CREATE INDEX IF NOT EXISTS idx_leads_treatment_type_id ON public.leads(treatment_type_id)';
  END IF;
END $$;
...
CREATE INDEX IF NOT EXISTS idx_side_effect_locks_playbook_id 
...
DROP INDEX IF EXISTS public.audit_log_resource_idx;
DROP INDEX IF EXISTS public.clinics_active_idx;
DROP INDEX IF EXISTS public.playbooks_owner_idx;
DROP INDEX IF EXISTS public.settlements_dni_idx;
DROP INDEX IF EXISTS public.settlements_dni_hash_idx;
DROP INDEX IF EXISTS public.settlements_template_idx;
DROP INDEX IF EXISTS public.appointments_clinic_date_idx;
DROP INDEX IF EXISTS public.leads_user_id_idx;
DROP INDEX IF EXISTS public.leads_stage_idx;
DROP INDEX IF EXISTS public.leads_external_id_idx;
DROP INDEX IF EXISTS public.leads_campaign_idx;
DROP INDEX IF EXISTS public.leads_phone_norm_idx;
DROP INDEX IF EXISTS public.leads_dni_hash_idx;
DROP INDEX IF EXISTS public.leads_no_show_idx;
DROP INDEX IF EXISTS public.leads_phone_normalized_idx;
DROP INDEX IF EXISTS public.leads_campaign_id_idx;
DROP INDEX IF EXISTS public.patients_clinic_dni_idx;
DROP INDEX IF EXISTS public.patients_clinic_phone_idx;
DROP INDEX IF EXISTS public.patients_dni_hash_idx;
DROP INDEX IF EXISTS public.patients_phone_normalized_idx;
DROP INDEX IF EXISTS public.wa_conv_lead_idx;
DROP INDEX IF EXISTS public.wa_conv_phone_idx;
DROP INDEX IF EXISTS public.wa_conv_clinic_idx;
DROP INDEX IF EXISTS public.meta_attribution_campaign_idx;
DROP INDEX IF EXISTS public.meta_attribution_lead_id_idx;
DROP INDEX IF EXISTS public.timeline_lead_idx;
DROP INDEX IF EXISTS public.doctoralia_raw_upload_idx;
DROP INDEX IF EXISTS public.agent_outputs_agent_type_idx;
DROP INDEX IF EXISTS public.side_effect_locks_user_id_idx;
DROP INDEX IF EXISTS public.side_effect_locks_created_at_idx;
DROP INDEX IF EXISTS public.agent_runs_status_idx;
DROP INDEX IF EXISTS public.agent_run_steps_run_id_idx;
DROP INDEX IF EXISTS public.agent_run_steps_created_at_idx;
DROP INDEX IF EXISTS public.lead_scores_lead_id_idx;
DROP INDEX IF EXISTS public.lead_scores_user_id_idx;
DROP INDEX IF EXISTS public.lead_scores_created_at_idx;

-- Monitoring schema unused indexes
DROP INDEX IF EXISTS monitoring.operational_events_user_id_idx;
DROP INDEX IF EXISTS monitoring.operational_events_created_at_idx;
DROP INDEX IF EXISTS monitoring.commands_user_id_idx;
