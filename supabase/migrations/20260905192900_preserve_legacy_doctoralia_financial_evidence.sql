...
--
-- This is not a duplicate of doctoralia_raw: Production validation shows
-- different row counts, date ranges and aggregates, so doctoralia_raw cannot
-- reconstruct the exact financial_settlements materialization being removed.
-- =============================================================================
