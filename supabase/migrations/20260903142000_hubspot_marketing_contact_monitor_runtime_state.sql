...
comment on function public.nvx_get_hubspot_marketing_contact_monitor() is
  'Authenticated Control Centre read-only projection of the canonical HubSpot marketing-contact threshold monitor, including freshness and bounded error state without archived contact PII.';
