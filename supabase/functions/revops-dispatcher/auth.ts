...
export type ExpectedSecretResolver = () => Promise<string | null | undefined>;
...
export async function authenticateDispatcherRequest(
  req: Request,
  resolveExpectedSecret: ExpectedSecretResolver,
