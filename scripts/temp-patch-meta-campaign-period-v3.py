...
# Preserve inferStatusFromLastLead. It is not part of the operational endpoint
# contract; removing it is unnecessary and could affect another historical consumer.
