  ...
  const req = https.request(options, (res) => {
    ...
    res.on('end', () => {
      if (res.statusCode >= 200 && res.statusCode < 300) {
        ...
        console.log("Debes crear el Webhook #2 manualmente en el Dashboard (es el método oficial y fiable):\n");
        console.log("=== PASOS EXACTOS EN EL DASHBOARD ===\n");
        console.log("1. Ve a: https://supabase.com/dashboard/project/" + PROJECT_REF + "/database/webhooks");
